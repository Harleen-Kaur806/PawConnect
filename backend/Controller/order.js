...
const Payment = async (req, res) => {
    ...
    try {
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            mode: 'payment',
            success_url: `https://pawconnect1.onrender.com/Order/Success?session_id={CHECKOUT_SESSION_ID}`,
...
const successUrl = `https://pawconnect11.netlify.app/success?orderId=${order._id}&email=${session.customer_email}&totalAmount=${order.totalAmount}&items=${serializedItems}`;
