...
const transporter = nodemailer.createTransport({
  service: 'gmail',
  auth: {
    user: 'pawconnect2003@gmail.com',
    pass: 'rzcirvpdlcdpnenn' // Use App Password if using Gmail
  }
});
...
const updateAppointmentStatus = async (req, res) => {
  try {
    ...
    if (status === 'Accepted') {
      userMessage = `Dear ${updated.ownerName},\n\nYour appointment request has been accepted. Please arrive on the scheduled date: ${updated.appointmentDate} at ${updated.appointmentTime} at this address{123 Ludhiana,Punjab}.\n\nThank you!`;
      ...
      userMessage = `Dear ${updated.ownerName},\n\nWe regret to inform you that your appointment request can't be fulfilled at this time due to certain reasons.\n\nThank you for your interest.`;
      docMessage = `Sir,\n\nThe appointment with ${updated.ownerName} has been rejected.\n\nRegards,\nPet Care Team`;
    }

    // Send email to user
    await transporter.sendMail({
      from: 'pawconnect2003@gmail.com',
      to: updated.email,
      subject,
      text: userMessage
    });
    ...
    await transporter.sendMail({
      from: 'pawconnect2003@gmail.com',
      to: 'tegveerparmar295@gmail.com', // Replace with actual doctor email or fetch from DB
      subject,
      text: docMessage
    });
