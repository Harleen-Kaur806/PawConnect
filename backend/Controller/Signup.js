...
const transporter = nodemailer.createTransport({
  service: "gmail",
  auth: {
    user: "pawconnect2003@gmail.com",      // replace with your email
    pass: "rzcirvpdlcdpnenn",         // replace with your app password
  },
});
...
const sendVerificationCode = async (req, res) => {
  ...
  try {
    ...
    const transporter = nodemailer.createTransport({
      service: "gmail",
      auth: {
        user: "pawconnect2003@gmail.com", // replace with your Gmail
        pass: "rzcirvpdlcdpnenn",    // use app password
      },
    });
