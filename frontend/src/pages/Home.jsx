...
const HomePage = () => {
  ...
  const videoUrl = 'https://www.youtube.com/watch?v=aNVuUqUcrL0';
    ...
    return (
        ...
        <div className="home">
              <div
  className="relative md:h-[100vh] h-[100vh] bg-cover bg-center 
             bg-[url('https://img.freepik.com/free-photo/vertical-closeup-shot-fat-white-cat-looking-right-dark_181624-41107.jpg?uid=R179980412&ga=GA1.1.790369633.1734678874&semt=ais_hybrid&w=740')] 
             md:bg-[url('https://media.istockphoto.com/id/172974164/photo/cat-and-dog-buddies-with-orange-background.jpg?s=612x612&w=0&k=20&c=k95AzlFdaP7L8Oy9zkGK3QGWA1DrGctObqjh6cLY7UQ=')]"
>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="bg-gray-50 p-6 rounded-lg shadow-md" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <p className="text-gray-600">
                                "Paw Connect is the perfect one-stop app for pet lovers! I found everything I needed—from grooming products to accessories—and even browsed pets available for adoption. Their team responded to my email within minutes. Super impressed!"
                            </p>
                        ...
                        <div className="bg-gray-50 p-6 rounded-lg shadow-md" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <p className="text-gray-600">
                                "The chatbot on Paw Connect is a game-changer! I asked about a home remedy for my dog’s itchy skin, and it instantly gave helpful, natural tips. It's like having a vet in your pocket. Super convenient and easy to use!"
                            </p>
                            <div className="flex text-yellow-400 mt-3">
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
                        ...
                        <div className="bg-gray-50 p-6 rounded-lg shadow-md" data-aos="fade-up" data-aos-delay="300">
                            ...
                            <p className="text-gray-600">
                                "This app has everything in one place—products, services, and even adorable pets looking for homes. I didn't expect such quick email support when I had a question. Smooth experience and such a thoughtful platform for pet lovers!"
                            </p>
                            <div className="flex text-yellow-400 mt-3">
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
