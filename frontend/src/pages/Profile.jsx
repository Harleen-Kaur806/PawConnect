  ...
  useEffect(() => {
    ...
    const fetchUserData = async () => {
      ...
      try {
        ...
        const response = await axios.get('https://pawconnect1.onrender.com/Signup/Get', {
    ...
    const fetchOrders = async () => {
      ...
      try {
        ...
        const response = await axios.get('https://pawconnect1.onrender.com/Order/Orderhistory', {
          params: { email }, // Pass email as query parameter
        });
        console.log(response.data);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white shadow-lg rounded-lg p-6">
          ...
          <div className="space-y-4">
            {orders?.length === 0 ? (
              <p>The profile will be visible only after you make a purchase.</p>
            ) : (
              orders.map((order) => (
