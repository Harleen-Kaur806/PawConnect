...
const AboutPage = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      title: "Safety First",
      description: "Safety comes first every product, remedy, and adoption partner is carefully checked to keep your pet healthy and protected."
    },
    {
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="aos-animate">
              ...
              <div className="text-lg text-gray-600 space-y-4">
                <p>
                <b>PawConnect</b>- For Every Paw, With Love. It all started with a simple idea: to make life easier, 
                  healthier, and happier for pets and their humans. As pet lovers ourselves, we often found it frustrating 
                  to jump from one site to another—one for products, another for advice, and yet another for adoption services. 
                </p>
                <p>
                 That's when Paw Connect was born. We dreamed of creating a one-stop app and website where everything a pet parent 
                 needs is just a tap away. From quality pet products and grooming essentials to instant email support and even home 
                 remedies through our smart chatbot, Paw Connect brings it all together.
                </p>
                <p>
                  But we didn't stop there. Our hearts led us to include a pet adoption feature—to help connect loving families with pets 
                  looking for forever homes. It's our way of giving back to the paws that bring us so much joy. Whether you're here to shop, 
                  learn, or adopt, we welcome you to the Paw Connect family—where every wag, purr, and nuzzle finds care, comfort, and love.
                </p>
              </div>
            </div>
            <div className="aos-animate">
