...
const CartPage = () => {
    ...
    const fetchCartData = async () => {
        ...
        if (emailId) {
            try {
                const response = await axios.get(`https://pawconnect1.onrender.com/Cart/Get?emailId=${emailId}`);
  ...
  const updateCartInBackend = async (updatedItems) => {
      ...
      if (emailId) {
          try {
              await axios.put('https://pawconnect1.onrender.com/Cart/Update', { emailId, products: updatedItems });
          } catch (error) {
    ...
    const handleSaveAddress = async () => {
        ...
        if (validateAddress()) {
            if (email) {
                try {
                    await axios.post('https://pawconnect1.onrender.com/Signup/SaveAddress', { email, address });
    ...
    const handlePayment = async () => {
        ...
        try {
            const response = await axios.post('https://pawconnect1.onrender.com/Order/create-payment-intent', orderData);
    ...
    const handleRemoveItem = async (productId) => {
        ...
        try {
            ...
            const response = await axios.post("https://pawconnect1.onrender.com/Cart/Delete", { emailId, productId});
