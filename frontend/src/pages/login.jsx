...
const LoginWithGoogleButton = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post("https://pawconnect1.onrender.com/Signup/validate", data);
  ...
  const handleGoogleLogin = async (response) => {
    try {
      ...
      const result = await axios.post("https://pawconnect1.onrender.com/Signup/GoogleLogin", {
        Name: name,
        Email: email,
        GoogleId: googleId,
      });
