...
const ForgotPassword = () => {
  ...
  const handleSendCode = async () => {
    try {
      const res = await axios.post("https://pawconnect1.onrender.com/signup/sendVerificationCode", { email });
  ...
  const handleResetPassword = async () => {
    try {
      const res = await axios.post("https://pawconnect1.onrender.com/signup/resetPassword", {
        email,
        verificationCode,
        newPassword
      });
