...
const RegistrationForm = () => {
  ...
  const handleSendOtp = async () => {
    ...
    try {
      setLoading(true);
      const response = await fetch("https://pawconnect1.onrender.com/Signup/verifyotp", {
        method: "POST",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      const response = await fetch("https://pawconnect1.onrender.com/Signup/save", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  useEffect(() => {
    if (window.google && googleButtonRef.current) {
      window.google.accounts.id.initialize({
        client_id: "914411916279-0avjr2d3a3rcikd4f5rnh22gsirfn3o2.apps.googleusercontent.com",
  ...
  const handleGoogleResponse = async (response) => {
    ...
    try {
      const res = await fetch("https://pawconnect1.onrender.com/Signup/GoogleSave", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
