...
function ProductPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (editingId) {
                response = await axios.put(`https://pawconnect1.onrender.com/product/Update/${editingId}`, formData, {
                    headers: { 'Content-Type': 'multipart/form-data' }
                });
            } else {
                response = await axios.post('https://pawconnect1.onrender.com/product/Save', formData, {
                    headers: { 'Content-Type': 'multipart/form-data' }
                });
            }
            if (response) {
    ...
    const handleDelete = async (id) => {
        ...
        if (confirmDelete) {
            try {
                await axios.delete(`https://pawconnect1.onrender.com/product/Delete/${id}`);
