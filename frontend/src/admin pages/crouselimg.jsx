...
function Crouselimg() {
  ...
  const addImage = async () => {
    ...
    try {
      const response = await axios.post("https://pawconnect1.onrender.com/Crousel/Save", formData, {
  ...
  const deleteImage = async (id) => {
    try {
      await axios.delete(`https://pawconnect1.onrender.com/Crousel/Delete/${id}`);
  ...
  const editImageDetails = async () => {
    ...
    try {
      const response = await axios.put(
        `https://pawconnect1.onrender.com/Crousel/Update/${editImage._id}`,
