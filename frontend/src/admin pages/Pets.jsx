...
const Pets = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingPet) {
        await axios.put(`https://pawconnect1.onrender.com/pet/Update/${editingPet._id}`, data, {
          headers: { "Content-Type": "multipart/form-data" },
        });
      } else {
        await axios.post("https://pawconnect1.onrender.com/pet/Save", data, {
          headers: { "Content-Type": "multipart/form-data" },
        });
      }
      await fetchPets();
  ...
  const deletePet = async (id) => {
    try {
      await axios.delete(`https://pawconnect1.onrender.com/pet/Delete/${id}`);
