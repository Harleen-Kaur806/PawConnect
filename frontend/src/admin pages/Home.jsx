...
import { IndianRupee, ShoppingCart, Users, Bone } from 'lucide-react';
...
const Home = () => {
  ...
  const productCategories = [
    ...
    { category: 'Healthcare', sales: 13000 },
    { category: 'Accessory', sales: 16000 },
    { category: 'Grooming', sales: 3000 }
  ];
  ...
  const recentOrders = [
    ...
    { id: '3', customer: 'Mike R.', product: 'Pet Shampoo', amount: 24.99, status: 'Processing' },
  ];

  return (
    <div className="p-6 w-full md:w-[85%] ml-0 md:ml-64 mt-20 md:mt-16 mx-auto space-y-6">
      {/* Header */}
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
        <h1 className="text-3xl font-bold">Paw Connect Dashboard</h1>
        <button 
          onClick={() => setShowStatsModal(true)}
          className="mt-4 md:mt-0 px-4 py-2 bg-yellow-500 text-white rounded-lg hover:bg-yellow-600 transition-colors"
        >
          View Details
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            <IndianRupee className="h-8 w-8 text-green-500 mr-4" />
            <div>
          ...
          <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
            ...
            <div className="space-y-4">
              <p className="text-sm text-gray-500">
                ...
                Customer Retention: 45%<br />
                Average Order Value: ₹20<br />
                Top Selling Category: Pet Accessory<br />
                Active Customers: 10
              </p>
            </div>
